...
- Domain-classifier test accuracy: 0.5075 [0.4999, 0.5153]
...
- Geometry baseline (edge-endpoint coordinates, domain labels): accuracy=0.6573 [0.6495, 0.6650], chance=0.5000

## Behavior classification (head ID)
- Behavior classifier: accuracy=0.7875 [0.7500, 0.8229], chance=0.1250
- Head residual cosine similarity (off-diagonal mean): -0.1273
