...
- Domain-classifier test accuracy: 0.5000 [0.4919, 0.5077]
...
- Permutation test: p=0.6400 (mean=0.4995, std=0.0239, trials=50)
...
- Geometry baseline (edge-endpoint coordinates, domain labels): accuracy=0.9109 [0.9064, 0.9154], chance=0.5000

## Behavior classification (head ID)
- Behavior classifier: accuracy=0.8417 [0.8063, 0.8729], chance=0.1250
- Head residual cosine similarity (off-diagonal mean): -0.0934
- Head top-5% edge overlap (off-diagonal mean): 0.9935
- Phase-behavior coupling (Cramér's V): 0.0335 (chi² p=0.0003894)
- Mean win-step per head: 4.46, 4.47, 4.46, 4.55, 4.51, 4.42, 4.65, 4.50
