        ...
        for instance in instance_bar:
            ...
            rows.append(
                CapacityInstanceResult(
                    ...
                    mean_guidance=safe_metric_mean(prior_mean),
                    pheromone_correlation=safe_metric_mean(corr),
                )
            )
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.output_json is None or args.output_csv is None:
        default_json, default_csv = default_output_paths(args.checkpoint)
